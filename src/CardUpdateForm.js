...
class CardUpdateForm extends React.Component {
  handleNameChange = (e) => {
    // Passing name change handler to parent
    this.props.changeName(e.target);
  };

  handleTypeChange = (e) => {
    // Passing type change handler to parent
        ...
        <div className="ui fluid card">
          ...
          <div className="content">
            <div className="ui right labeled input">
              ...
              ></input>
              <a className="ui label" onClick={this.handleUpdateClick}>
                Update
              </a>
            </div>
