          ...
          (y = {
              ...
              label: {
                click: function (t) {
                  var n = e(this),
                    ...
                    r =
                      o.length > 0
                        ? n.nextUntil(o).add(a).add(n)
                        : n.prevUntil(s).add(a).add(n);
                  t.shiftKey
                    ...
                    t == I.leftArrow
                      ? (!m && !f) || r
                        ? r &&
                          ...
                          c && !l
                            ? a.addClass(T.active)
                            : a.prev(O.siblingLabel).addClass(T.active).end(),
                          e.preventDefault())
                        : (y.verbose("Selecting previous label"),
            ...
            add: {
              ...
              message: function (t) {
                ...
                n.length > 0
                  ? n.html(i)
                  : (n = e("<div/>").html(i).addClass(T.message).appendTo(W));
              },
                ...
                if (!A.useLabels || !y.has.maxSelections()) {
                  ...
                  o
                    ...
                    (A.hideAdditions && !y.is.allFiltered()) ||
                      n.addClass(T.selected).siblings().removeClass(T.selected),
                    y.refreshItems();
                }
              },
